 ...
 */
public class JGPSplashWindow extends Window {
    /**
     * The current instance of the splash window.
     * (Singleton design pattern).
     */
    private static JGPSplashWindow instance;
     ...
     */
    private JGPSplashWindow(Frame parent, Image image) {
        super(parent);
        this.image = image;
        ...
        MouseAdapter disposeOnClick = new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                ...
                // has been painted.
                synchronized(JGPSplashWindow.this) {
                    JGPSplashWindow.this.paintCalled = true;
                    JGPSplashWindow.this.notifyAll();
                }
                dispose();
            }
        };
    ...
    public static void splash(Image image) {
        if (instance == null && image != null) {
            ...
            instance = new JGPSplashWindow(f, image);
     ...
     */
    public static void invoke(String className, String methodName, String[] args) {
        try {
